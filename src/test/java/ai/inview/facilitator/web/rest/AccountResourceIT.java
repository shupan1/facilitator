...
import static ai.inview.facilitator.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static ai.inview.facilitator.test.util.OAuth2TestUtil.authenticationToken;
import static ai.inview.facilitator.test.util.OAuth2TestUtil.registerAuthenticationToken;
