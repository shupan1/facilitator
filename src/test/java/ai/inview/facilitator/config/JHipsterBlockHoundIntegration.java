...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ai.inview.facilitator.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ai.inview.facilitator.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
